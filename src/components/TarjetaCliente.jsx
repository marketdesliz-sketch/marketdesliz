        ...
        <div className="p-5 flex flex-col h-full">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6 text-center">
            <div>
              ...
              <div className="text-2xl font-bold text-gray-800">${pagoSemanal.toLocaleString()}</div>
            </div>
            <div>
              <div className="text-xs text-gray-500">Total a pagar</div>
              <div className="text-2xl font-bold text-purple-700">${totalPagar.toLocaleString()}</div>
            </div>
          </div>
